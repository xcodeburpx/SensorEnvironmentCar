...
from tensor_networks.Double_Deep_Q_Network import DoubleDuelingQNetwork
...
with tf.variable_scope("Double_DQN"):
    double_DQN = DoubleDuelingQNetwork(n_actions=ACTION_SPACE, state_shape=OBSERVATION_SPACE, memory_size=MEMORY_SIZE,
    ...
    while True:
        ...
        if total_steps % 50 == 0:
            print("Step: {}, Act: {}, Rrd: {}, Done: {} Eps:{}, Pos: {}".format(total_steps,
                                                                             ACTION_NAMES[action], reward, done, RL.epsilon, position))
...
def test(RL):
    ...
    # Load model
    model = path+"/DoubleDQN-100000.ckpt"
